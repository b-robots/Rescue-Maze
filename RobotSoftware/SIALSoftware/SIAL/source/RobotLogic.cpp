...
namespace SIAL
{
	namespace RobotLogic
	{
		...
		bool getNextDrivingDir(FusedData fusedData, RelativeDir& nextDir) {
			// TODO
			uint8_t noImaginaryConnection = ~(~fusedData.gridCell.cellConnections | imaginaryWalls);//fusedData.gridCell.cellConnections;
